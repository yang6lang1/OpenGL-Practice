...
public class PerspectivePrism {


  // Whether to enable VSync in hardware.
  public static final boolean VSYNC = true;
  public static final String vertexShaderFilePath = "/Data/tut04/manualPerspectiveVertexShader.txt";
  ...
  private void initializeProgram() {
	...
	int frustumScaleUnif = glGetUniformLocation(programObject, "frustumScale");
	int zNearUnif = glGetUniformLocation(programObject, "zNear");
	int zFarUnif = glGetUniformLocation(programObject, "zFar");
