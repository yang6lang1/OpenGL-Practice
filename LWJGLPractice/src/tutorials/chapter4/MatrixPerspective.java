...
public class MatrixPerspective {
  ...
  public static final String vertexShaderFilePath = "/Data/tut04/matrixPerspectiveVertexShader.txt";
...
//	float frustumScale = 1.0f; float zNear = 1.0f; float zFar = 3.0f;
//	FloatBuffer matrixBuffer = BufferUtils.createFloatBuffer(16);
//	for(int i = 0; i < matrixBuffer.capacity(); i++){
//		float m = 0.0f;
//		if(i == 0){
//		  m = frustumScale / (Display.getWidth()/ (float)Display.getHeight());
//		}
//		else if(i == 5){
//			m = frustumScale;
//		}
//		else if(i == 10){
//			m = (zNear + zFar) / (zNear - zFar); 
//		}
//		else if(i == 11){
//			m = -1;
//		}
//		else if(i == 14){
//			m = (2 * zNear * zFar) / (zNear - zFar);
//		}
//		
//		matrixBuffer.put(m);
//	}
...
//	
//	int perspectiveMatrixLocation = glGetUniformLocation(programObject, "perspectiveMatrix");
//	glUseProgram(programObject);
//	glUniformMatrix4(perspectiveMatrixLocation, false, matrixBuffer);
//	glUseProgram(0);
  ...
  private void initializeProgram() {
	...
	glUseProgram(programObject);
	/*
	 * The 2nd boolean parameter tells OpenGL what the ordering of the matrix data is.
	 * If it is true, then the matrix data is in row-major order. Since our data is 
	 * column-major, we set it to false.
	 */
	glUniformMatrix4(perspectiveMatrixLocation, false, matrixBuffer);
	glUseProgram(0);
