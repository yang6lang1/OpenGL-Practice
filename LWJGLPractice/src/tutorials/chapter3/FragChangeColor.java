...
public class FragChangeColor {
  ...
  public static final String fragShaderFilePath = "/Data/tut03/timeBasedFragmentShader.txt";
  ...
  private void initializeProgram() {
	...
	int fragLoopDurLocation = glGetUniformLocation(programObject, "fragLoopDuration");
	int loopDurationLocation = glGetUniformLocation(programObject, "loopDuration");
	glUseProgram(programObject);
	glUniform1f(fragLoopDurLocation, 2.5f);
